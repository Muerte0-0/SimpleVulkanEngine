...
private:
	...
	void CreateTextureImage()
	{
		...
		CreateImage(texWidth, texHeight, texMipLevels,
	...
	vk::raii::ImageView CreateImageView(vk::raii::Image& image, vk::Format format, vk::ImageAspectFlags aspectFlags, uint32_t mipLevels) const
	{
